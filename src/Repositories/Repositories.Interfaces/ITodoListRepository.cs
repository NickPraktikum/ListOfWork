namespace devdeer.ListOfWork.Repositories.Interfaces
{
    ...
    public interface ITodoListRepository
    {
        ...
        Task<TodoItemModel> CreateTodo(CreateTodoItemModel createTodo);
        /// <summary>
        /// Retrieves all of the <see cref="TodoItemModel"/>s from the backend.
        /// </summary>
        /// <returns>An array of <see cref="TodoItemModel"/>s or <c>null</c> if no items were found in the backend.</returns>
        Task<IEnumerable<TodoItemModel>?> GetAllTodos();
        /// <summary>
        ...
        Task<TodoItemModel?> GetById(string id);
        /// <summary>
        ...
        /// <returns>A <see cref="TodoItemModel"/> with the provided <paramref name="id"/> and updated data from <paramref name="updateTodo"/> or <c>null</c> if the <see cref="TodoItemModel"/> wasn't found in the backend.</returns>
        Task<TodoItemModel?> UpdateTodo(string id, UpdateTodoItemModel updateTodo);
    }
}
