namespace devdeer.ListOfWork.Logic.Interfaces
{
    ...
    public interface ITodoListRepository
    {
        ...
        /// <see cref="TodoItemModel" /> with provided <paramref name="id" /> wasn't found in the backend.
        /// </returns>
        ...
        /// <param name="id">The id of the <see cref="TodoItemModel" /> in the backend.</param>
        /// <returns>
        /// <c>true</c> if the <see cref="TodoItemModel" /> with the provided <paramref name="id" /> was successfully
        /// deleted or <c>false</c> if the <see cref="TodoItemModel" /> wasn't deleted from the backend.
        /// </returns>
        ...
        /// <returns>
        /// A <see cref="TodoItemModel" /> and updated data from <paramref name="updateTodo" /> or <c>null</c> if the
        /// <see cref="TodoItemModel" /> wasn't found in the backend.
        /// </returns>
