namespace devdeer.ListOfWork.Logic.Interfaces
{
    ...
    public interface ITodoListLogic
    {
        ...
        /// </summary>
        /// <returns>
        /// An list of <see cref="TodoItemModel" />s present in the backend or <c>null</c> if no available
        /// <see cref="TodoItemModel" />s were found in the backend.
        /// </returns>
        ...
        /// <returns>
        /// A <see cref="TodoItemModel" /> with the provided <paramref name="id" /> or <c>null</c> if the
        /// <see cref="TodoItemModel" /> with the <paramref name="id" /> wasn't found in the backend.
        /// </returns>
        ...
        /// <returns>
        /// <c>true</c> if the <see cref="TodoItemModel" /> with the provided <paramref name="id" /> was deleted from the
        /// backend or <c>false</c> if the <see cref="TodoItemModel" /> with the <paramref name="id" /> couldn't be deleted.
        /// </returns>
        ...
        /// <returns>
        /// A <see cref="TodoItemModel" />, whose <see cref="TodoItemModel.CompletedAt" /> is set to
        /// <see cref="DateTimeOffset.UtcNow" /> if the <see cref="TodoItemModel" /> with the provided <paramref name="id" /> was
        /// found or <c>null</c> if the <see cref="TodoItemModel" /> with the <paramref name="id" /> wasn't found.
        /// </returns>
        ...
        /// <returns>
        /// A <see cref="TodoItemModel" /> whose data was updated to <paramref name="updateTodoItem" /> or <c>null</c> if
        /// the <see cref="TodoItemModel" /> wasn't found in the backend.
        /// </returns>
        Task<TodoItemModel?> UpdateTodoAsync(string id, TodoItemModel updateTodoItem);
