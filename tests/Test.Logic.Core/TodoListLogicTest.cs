...
{
    using ListOfWork.Logic.Common.Exceptions;
    using ListOfWork.Logic.Core;
    ...
    public class TodoListLogicTest
    {
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.CreateTodoAsync" /> raises an exception when non-valid
        /// <see cref="TodoItemModel.Title" /> is provided. <see cref="TodoItemModel.Title" /> has to be a valid string without
        /// empty spaces or  be <c>null</c>.
        /// </summary>
        [Test]
            ...
            Assert.Multiple(
                () =>
                {
                    Assert.ThrowsAsync<ArgumentException>(
                        () => logic.CreateTodoAsync(
                            new CreateTodoItemModel
                            {
                                Title = string.Empty,
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.CreateTodoAsync" /> raises an exception when non-valid
        /// <see cref="TodoItemModel.Description" /> is provided. <see cref="TodoItemModel.Description" /> has to be a valid
        /// <see cref="string" /> without empty spaces or  be <c>null</c>.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.CreateTodoAsync" /> raises an exception when non-valid
        /// <see cref="TodoItemModel.DueTime" /> is provided. <see cref="TodoItemModel.DueTime" /> has to be a
        /// <see cref="DateTimeOffset" /> that is bigger and not equal to <see cref="TodoItemModel.CreatedAt" />.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.CreateTodoAsync" /> creates a valid <see cref="TodoItemModel.Id" />.
        /// <see cref="TodoItemModel.Id" /> has to have 4 characters and be a valid <see cref="string" /> without empty spaces or
        /// be <c>null</c>.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.CreateTodoAsync" /> assigns right values to the properties in
        /// <see cref="TodoItemModel" />.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.DeleteTodoAsync" /> requires a valid <see cref="TodoItemModel.Id" />.
        /// <see cref="TodoItemModel.Id" /> has to have 4 characters and be a valid <see cref="string" /> without empty spaces or
        /// be <c>null</c>.
        /// </summary>
        [Test]
        public void DeleteTodoRequiresValidId()
        {
            // Arrange
            var logic = LogicToTest;
            var validId = _testTodoItems!.First()
                .Id;
            // Act & Assert
            Assert.Multiple(
                () =>
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.DeleteTodoAsync" /> returns <c>true</c> after successful <see cref="TodoItemModel" />
        /// deletion.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.GetAllTodosAsync" /> returns proper <see cref="TodoItemModel" />s with
        /// <see cref="_testTodoItems" /> provided.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.GetTodoByIdAsync" /> requires a valid <see cref="TodoItemModel.Id" />.
        /// <see cref="TodoItemModel.Id" /> has to have 4 characters and be a valid <see cref="string" /> without empty spaces or
        /// be <c>null</c>.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.GetTodoByIdAsync" /> returns a <see cref="TodoItemModel" /> if it's found in the
        /// backend or <c>null</c> otherwise.
        /// </summary>
        [Test]
        public async Task GetTodoByIdReturnsNullIfTodoItemNotFound()
        {
            ...
            var logic = LogicToTest;
            var wrongId = "1111";
            var rightId = _testTodoItems!.First()
                .Id;
            // Act 
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.SetTodoToCompleteAsync" /> requires a valid <see cref="TodoItemModel.Id" />.
        /// <see cref="TodoItemModel.Id" /> has to have 4 characters and be a valid <see cref="string" /> without empty spaces or
        /// be <c>null</c>.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.SetTodoToCompleteAsync" /> can't set completed
        /// <see cref="TodoItemModel.CompletedAt" /> to completed.
        /// </summary>
        [Test]
        public void SetTodoToCompleteRequiresUnCompletedTodoItem()
        {
            // Assert
            var logic = LogicToTest;
            var completedTodoId = _testTodoItems!.Where(todo => todo.CompletedAt != null)
                .First()
                .Id;
            var uncompletedTodoId = _testTodoItems!.Where(todo => todo.CompletedAt == null)
                .First()
                .Id;
            // Act & Assert
            Assert.Multiple(
        ...
        public void SetTodoToCompleteRequiresExistingTodo()
        {
            // Arrange
            var logic = LogicToTest;
            var validId = _testTodoItems!.Where(todo => todo.CompletedAt == null)
                .First()
                .Id;
            // Act & Assert
            Assert.Multiple(
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.SetTodoToCompleteAsync" /> assigns right values to the properties in
        /// <see cref="TodoItemModel" />.
        /// </summary>
        [Test]
        public async Task SetTodoToCompleteAssignsProperValues()
        {
            ...
            var validTodo = _testTodoItems!.Where(todo => todo.CompletedAt == null)
                .First();
            // Act
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.SetTodoToCompleteAsync" /> assigns current <see cref="DateTimeOffset.UtcNow" /> to
        /// the <see cref="TodoItemModel.CreatedAt" /> property of <see cref="TodoItemModel" />.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.SetTodoToCompleteAsync" /> only allows to set <see cref="TodoItemModel" /> to
        /// completed only if the <see cref="TodoItemModel" /> hasn't been expired yet(<see cref="TodoItemModel.DueTime" /> is
        /// expired).
        /// </summary>
        [Test]
        public void SetTodoToCompleteRequiresValidTodos()
        {
            // Assert
            var logic = LogicToTest;
            var validTodo = _testTodoItems!.Where(todo => todo.DueTime > todo.CompletedAt)
                .First()
                .Id;
            var invalidTodo = _testTodoItems!.Where(todo => todo.DueTime < todo.CompletedAt)
                .First()
                .Id;
            // Act & Assert
            Assert.Multiple(
        ...
        public void SetTodoToCompleteRequiresNotExpiredTodo()
        {
            ...
            var validTodo = _testTodoItems!.Where(todo => todo.DueTime > dateTimeNow)
                .First();
            var invalidTodo = _testTodoItems!.Where(todo => todo.DueTime < dateTimeNow)
                .First();
            // Act & Assert
            Assert.Multiple(
                () =>
        ...
        /// <see cref="TodoItemModel.Title" /> has to be a valid <see cref="string" /> without empty spaces or  be <c>null</c>.
        /// </summary>
        [Test]
        ...
        /// <see cref="TodoItemModel.Description" /> has to be a valid <see cref="string" /> without empty spaces or  be
        /// <c>null</c>.
        /// </summary>
        [Test]
        ...
        /// <see cref="TodoItemModel.DueTime" /> has to be a <see cref="DateTimeOffset" /> that is bigger and not equal to
        /// <see cref="TodoItemModel.CreatedAt" />.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.UpdateTodoAsync" /> requires a valid completed at date time for
        /// <see cref="TodoItemModel" />. <see cref="TodoItemModel.CompletedAt" /> has to be smaller than
        /// <see cref="TodoItemModel.DueTime" />.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.UpdateTodoAsync" /> requires a valid due time for <see cref="TodoItemModel" />.
        /// <see cref="TodoItemModel.CompletedAt/> has to be a <see cref="DateTimeOffset" /> that is bigger and not equal to
        /// <see cref="TodoItemModel.CreatedAt" />.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Tests if <see cref="TodoListLogic.UpdateTodoAsync" /> assigns proper values for <see cref="TodoItemModel" /> that are
        /// completed or not.
        /// </summary>
        [Test]
        public async Task UpdateTodoAssignsProperValues()
        {
            ...
            var logic = LogicToTest;
            var dateNow = DateTimeOffset.UtcNow;
            var validUncompletedTodo = _testTodoItems!.Where(todo => todo.CompletedAt == null)
                .First()
                .Id;
            var validCompletedTodo = _testTodoItems!.Where(todo => todo.CompletedAt != null)
                .First()
                .Id;
            ...
            // Act
            var resultUncompletedTodo = await logic.UpdateTodoAsync(validUncompletedTodo, updateUncompletedTodo);
            var resultCompletedTodo = await logic.UpdateTodoAsync(validCompletedTodo, updateCompletedTodo);
            // Assert
            Assert.Multiple(
                () =>
                {
